        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-stone-900 pt-16 space-y-10 text-stone-300 font-sans pb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
            <div className="space-y-3">
              <h3 className="text-xl font-sans font-bold text-amber-500">Nguồn Gốc Tuyển Chọn</h3>
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-sans font-bold text-amber-500">Nghệ Thuật Rang Mộc Thủ Công</h3>
              <p className="text-sm leading-relaxed text-stone-400">
          ...
          <div className="space-y-4 pt-4 border-t border-stone-900/50">
            <h3 className="text-xl font-sans font-bold text-stone-100">Tiêu Chuẩn Đánh Giá Cà Phê Đặc Sản (Specialty Coffee Grading)</h3>
            <p className="text-sm leading-relaxed text-stone-400">
          ...
          <div className="space-y-4 pt-4 border-t border-stone-900/50">
            <h3 className="text-xl font-sans font-bold text-stone-100">Hướng Dẫn Bảo Quản Cà Phê Hạt Nguyên Bản</h3>
            <p className="text-sm leading-relaxed text-stone-400">
          ...
          <div className="bg-stone-900/40 border border-stone-900 p-6 rounded-2xl space-y-4">
            <h3 className="text-lg font-sans font-bold text-stone-100 text-center">Cam Kết Chất Lượng Đỉnh Cao Cho Cộng Đồng</h3>
